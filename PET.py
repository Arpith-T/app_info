...
def cpi_prod_version():
    url = "https://api.cf.sap.hana.ondemand.com/v3/apps?page=1&per_page=1000&space_guids=ae86fb6d-9b9a-42dc-9897-2eff16d18cd8&names=it-co"
...
def push_app_info():
    ...
    for app in app_list:
        url = f"https://api.cf.sap.hana.ondemand.com/v3/apps?page=1&per_page=1000&space_guids=ae86fb6d-9b9a-42dc-9897-2eff16d18cd8&names={app}"
