...
def aws_cf_oauth_token():
    ...
    headers = {
        ...
        'Cookie': 'JTENANTSESSIONID_kr19bxkapa=hXwfyso6e1%2FiD%2BzG%2FmTvccGsC%2F0%2F2O89fpaXQYYhBOU%3D; JSESSIONID=ODUyMDhkYjYtNWE2MC00ZTM0LWIwZDYtN2U0MDQ3NTk2NDVh; __VCAP_ID__=b648ffdc-d041-45a8-6668-e81a314c9fb6'
    }
    ...
    aws_pet_ext_token = response.json()
...
def cpi_prod_version():
    ...
    url = f"https://api.cf.eu12-001.hana.ondemand.com/v3/apps/{co_guid}/environment_variables"
...
def push_app_info():
    ...
    for app in app_list:
        url = f"https://api.cf.eu12-001.hana.ondemand.com/v3/apps?page=1&per_page=1000&space_guids=d8892cc5-7a90-4274-89fc-7f7f9e3eec08&names={app}"
